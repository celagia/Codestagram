...
<div class="container">
    ...
    <div class="row pt-5">
        <div class="col-4">
            <img src="https://cdn.pixabay.com/photo/2016/11/19/14/00/code-1839406_1280.jpg" class="w-100"
        ...
        <div class="col-4">
            <img src="https://edsurge.imgix.net/uploads/post/image/12176/coding-1556754232.jpg?auto=compress%2Cformat&w=1024&h=512&fit=crop"
                class="w-100" style="object-fit: cover;" width=300px height=300px>
        </div>
        <div class="col-4">
            <img src="https://cdn-wordpress-info.futurelearn.com/wp-content/uploads/Coding_Blog_Header_1500x750-606x303.jpg.optimal.jpg"
                class="w-100" style="object-fit: cover;" width=300px height=300px>
        </div>
    </div>
</div>
